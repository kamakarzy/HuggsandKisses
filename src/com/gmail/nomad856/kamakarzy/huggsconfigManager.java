...
public class huggsconfigManager {
	 ...
	 */
	public huggsconfigManager(JavaPlugin plugin) {
		this.plugin = plugin;
	}
	 ...
	 */
	public huggsconfig getNewConfig(String filePath, String[] header) {
		...
		huggsconfig config = new huggsconfig(this.getConfigContent(filePath),
	 ...
	 * @return - New SimpleConfig
	 */
	public huggsconfig getNewConfig(String filePath) {
