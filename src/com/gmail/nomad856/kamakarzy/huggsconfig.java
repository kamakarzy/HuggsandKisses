...
public class huggsconfig {
	private int comments;
	private huggsconfigManager manager;

	private File file;
	private FileConfiguration config;

	public huggsconfig(InputStream configStream, File configFile, int comments,
			JavaPlugin plugin) {
		this.comments = comments;
		this.manager = new huggsconfigManager(plugin);
